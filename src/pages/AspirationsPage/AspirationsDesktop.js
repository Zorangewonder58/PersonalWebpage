...
function AspirationsDesktop({onToggle})
{
    ...
    return (
        <div className="Aspirations" id='mainDesktop'>
            <div id='content-wrap'>
                <header>
                    <h1>
                        Experience
                ...
                <div className='AspirationSection' style={borderright}>
                    ...
                    <p>Starting this job in quarantine was an interesting experience.
                        While dealing with the conditions of the time, I was facing my first exposure to customer
                        service.
                ...
                <div className='AspirationSection' style={borderleft}>
                    ...
                    <p>This job brought me experience in programming as well as teaching. Through my experience with
                        this
                        job, I have gained an appreciation
                        for numerous methods to learn and grow. Watching my tutees excel fills me with pride
                        everyday</p>
                </div>
                ...
                <div className='AspirationSection' style={borderleft}>
                    ...
                    <p>This internship was a Software Engineering Internship. During this Internship, I learned a great
                        deal: Including Sprint work cycles, Using Company Frameworks, and adopting concept work into
                        ongoing
                ...
                <p>When aspiring to be a developer, it is important to build your skills on your own. This can't be done
                    in
                    the classroom, it can only be done through independent research and experience. This can be done
                    through
                    personal projects, solving leetcode problems, etc. It is crucial that a developer is always
                    learning.
                    For this reason, I have started numerous projects on my own to build my knowledge. This includes: An
                    app
                    in JavaFX, this Website, and some indie games to name a few. Pursuing these projects have taught me
                    alot
                ...
                <p>For the past few years, I have been pursuing a bachelors in Computer Science at Florida Agricultural
                    and
                    Mechanical University. Before I attended this program, I had a vested interest in computer science,
                    however it grew stagnant. So much so, that I initially majored in architecture. Since changing my
                    major,
...
export default AspirationsDesktop;