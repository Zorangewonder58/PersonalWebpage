  ...
  const center =
  {
    ...
    <main>
      ...
      <div className='ProjectsSections'>
        ...
        <p> A desktop application that returns motivations from a database and allows users to add to it. Created using
      ...
      <div className='ProjectImages'>
        <img src={PythonCreatives} alt="Picture of a screen"/>
      </div>
      <div className="ProjectsSections">
        <h2>Connectz App: </h2>
